        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <div class="animate-fade-in">
                <h1 class="text-5xl md:text-6xl font-bold text-white mb-6">
                    Selamat Datang, <span class="block text-6xl md:text-7xl mt-2">{{ Auth::user()->name }}! 👋</span>
                </h1>
                @php
                ...
                <p class="text-xl md:text-2xl text-blue-100 mb-8 max-w-3xl mx-auto">
                    Anda login sebagai <span class="font-bold capitalize">{{ $role }}</span>. {{ $descriptionText }}
                </p>
                <a href="{{ $dashboardUrl }}" class="inline-flex items-center px-8 py-4 bg-white text-blue-600 font-bold text-lg rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105 shadow-2xl">
                    <i class="fas fa-tachometer-alt mr-3 text-xl"></i>{{ $dashboardText }}
                </a>
            </div>
        </div>
    </div>
