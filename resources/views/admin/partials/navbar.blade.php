...
{{-- Pass $activeNav variable from each page to highlight active link --}}
{{-- e.g. @include('admin.partials.navbar', ['activeNav' => 'categories']) --}}
        ...
        @foreach($navLinks as $link)
            ...
            <a href="{{ $link['href'] }}"
               class="whitespace-nowrap py-2 px-3 border-b-2 font-medium text-sm transition-colors duration-150
                ...
                <i class="fas {{ $link['icon'] }} mr-1.5"></i>{{ $link['label'] }}
            </a>
        @endforeach
    </nav>
</div>
