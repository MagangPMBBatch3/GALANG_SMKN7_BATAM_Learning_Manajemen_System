            ...
            <div class="w-full max-w-md space-y-8">
                ...
                <form class="mt-8 space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <div class="flex items-center justify-between text-sm">
                        ...
                        <a href="<?php echo e(route('password.request')); ?>" class="text-indigo-200 hover:text-white font-medium transition">
                            Lupa password?
                        </a>
                    </div>
                    ...
                    <p class="text-center text-gray-300 text-sm">
                        Belum punya akun?
                        <a href="<?php echo e(url('/register')); ?>" class="font-bold text-white hover:underline">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maxcourse\resources\views\auth\login.blade.php ENDPATH**/ ?>