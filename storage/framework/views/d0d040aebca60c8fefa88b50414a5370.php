        ...
        <div class="max-w-7xl mx-auto px-4 py-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-slate-600 dark:text-slate-400 mt-1">Selamat datang kembali, <?php echo e(Auth::user()->name); ?>! 👋</p>
                </div>
                <div class="text-right">
                    <p class="text-sm text-slate-600 dark:text-slate-400">Anggota sejak <?php echo e(Auth::user()->created_at->format('M Y')); ?></p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\maxcourse\resources\views\dashboard\student.blade.php ENDPATH**/ ?>